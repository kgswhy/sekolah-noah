                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('equipment_name') is-invalid @enderror" id="equipment_name" name="equipment_name" required>
                                        ...
                                        <option value="Laptop" {{ old('equipment_name') == 'Laptop' ? 'selected' : '' }}>Laptop</option>
                                        <option value="Projector" {{ old('equipment_name') == 'Projector' ? 'selected' : '' }}>Projector</option>
                                        <option value="Camera" {{ old('equipment_name') == 'Camera' ? 'selected' : '' }}>Camera</option>
                                        <option value="Speaker" {{ old('equipment_name') == 'Speaker' ? 'selected' : '' }}>Speaker</option>
                                        <option value="Microphone" {{ old('equipment_name') == 'Microphone' ? 'selected' : '' }}>Microphone</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('loan_date') is-invalid @enderror" id="loan_date" name="loan_date" value="{{ old('loan_date') }}" required>
                                    @error('loan_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
