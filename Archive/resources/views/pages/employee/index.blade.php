...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="nav nav-tabs mb-3" id="employeeTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="nonaktif-tab" data-bs-toggle="tab" data-bs-target="#nonaktif" type="button" role="tab">Karyawan Tidak Aktif</button>
            </li>
        </ul>
                            ...
                            <tbody>
                                @foreach($employees->where('employee_status', 'aktif') as $employee)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/employee/{{ $employee->id }}/salary-components" class="btn btn-primary btn-sm">Komponen Gaji</a>
                                            <a href="/employee/edit/{{ $employee->id }}" class="btn btn-warning btn-sm">Edit</a>
                                            <a href="/employee/delete/{{ $employee->id }}" onclick="return confirm('Apakah anda yakin ingin menghapus data karyawan ini?');" class="btn btn-danger btn-sm">Hapus</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
