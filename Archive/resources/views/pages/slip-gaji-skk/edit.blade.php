...
<div class="d-flex align-items-center">
    <div class="me-auto">
        <h3 class="page-title">Edit Permintaan Slip Gaji / Surat Keterangan Kerja</h3>
...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('slip-gaji-skk.update', $request->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" name="jenis_permintaan" required>
                        ...
                        <option value="Slip Gaji" {{ $request->jenis_permintaan == 'Slip Gaji' ? 'selected' : '' }}>Slip Gaji</option>
                        <option value="Surat Keterangan Kerja" {{ $request->jenis_permintaan == 'Surat Keterangan Kerja' ? 'selected' : '' }}>Surat Keterangan Kerja</option>
                    </select>
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">Bulan/Tahun <span class="text-danger">*</span></label>
                    <input type="month" class="form-control" name="bulan_tahun" required value="{{ $request->bulan_tahun }}">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control" name="keterangan" rows="3" required>{{ $request->keterangan }}</textarea>
                </div>
                <div class="col-md-12 mb-4">
                    ...
                    <div class="form-text text-muted">
                        Biarkan kosong jika tidak ingin mengubah dokumen. File yang diterima: PDF, JPG, JPEG, PNG. Maksimal 2MB.
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex">
                <button type="submit" class="btn btn-primary me-2">
                    <i class="fas fa-save"></i> Perbarui Permintaan
                </button>
