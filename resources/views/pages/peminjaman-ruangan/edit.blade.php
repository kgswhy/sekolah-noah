...
<div class="d-flex align-items-center">
    <div class="me-auto">
        <h3 class="page-title">Edit Peminjaman Ruangan</h3>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_karyawan" name="nama_karyawan" 
                                    value="{{ old('nama_karyawan', $existingData['nama_karyawan']) }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="unit" class="form-label">Unit</label>
                                <input type="text" class="form-control" id="unit" name="unit" 
                                    value="{{ old('unit', $existingData['unit']) }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="departemen" class="form-label">Departemen</label>
                                <input type="text" class="form-control" id="departemen" name="departemen" 
                                    value="{{ old('departemen', $existingData['departemen']) }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="tanggal_pengajuan" class="form-label">Tanggal Pengajuan</label>
                                <input type="date" class="form-control" id="tanggal_pengajuan" name="tanggal_pengajuan" 
                                    value="{{ old('tanggal_pengajuan', $existingData['tanggal_pengajuan']) }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="tanggal_diperlukan" class="form-label">Tanggal Diperlukan</label>
                                <input type="date" class="form-control" id="tanggal_diperlukan" name="tanggal_diperlukan" 
                                    value="{{ old('tanggal_diperlukan', $existingData['tanggal_diperlukan']) }}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="waktu_pelaksanaan" name="waktu_pelaksanaan" 
                                    placeholder="Contoh: 09:00 - 12:00" value="{{ old('waktu_pelaksanaan', $existingData['waktu_pelaksanaan']) }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="nama_kegiatan" class="form-label">Nama Kegiatan</label>
                                <input type="text" class="form-control" id="nama_kegiatan" name="nama_kegiatan" 
                                    value="{{ old('nama_kegiatan', $existingData['nama_kegiatan']) }}" required>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="tempat_kegiatan" name="tempat_kegiatan" 
                                    value="{{ old('tempat_kegiatan', $existingData['tempat_kegiatan']) }}" required>
                            </div>
                            <div class="mb-3">
                                ...
                                <select multiple class="form-control" id="ruangan" name="ruangan[]" required>
                                    @php
                                        $selectedRooms = old('ruangan', $existingData['ruangan']);
                                    @endphp
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="jumlah" name="jumlah[]" min="1" 
                                    value="{{ old('jumlah.0', $existingData['jumlah'][0]) }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="keterangan" class="form-label">Keterangan</label>
                                <textarea class="form-control" id="keterangan" name="keterangan[]" rows="3">{{ old('keterangan.0', $existingData['keterangan'][0]) }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3">
